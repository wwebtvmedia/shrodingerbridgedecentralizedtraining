    ...
    var __webpack_modules__ = [
        ...
        (t, e, s) => {
                ...
                if (r.readyState === XMLHttpRequest.DONE) {
                  if (200 === r.status || 0 === r.status) {
                    ...
                    e && r.response
                      ...
                      : !e &&
                        r.responseText &&
                        (t = (0, i.stringToBytes)(r.responseText));
                    if (t) {
                      s(t);
                      return;
                    }
          ...
          class DOMStandardFontDataFactory
            extends n.BaseStandardFontDataFactory
          {
            _fetchData(t) {
        ...
        (t, e, s) => {
          ...
          class CanvasGraphics {
            ...
            _createMaskCanvas(t) {
              ...
              const E = i.Util.transform((0, n.getCurrentTransformInverse)(v), [
                1,
                0,
                0,
                1,
        ...
        (t, e, s) => {
          ...
          class AnnotationEditorLayer {
            ...
            addInkEditorIfNeeded(t) {
              if (!t && this.#pt.getMode() !== i.AnnotationEditorType.INK)
                return;
              if (!t)
          ...
          class AnnotationElement {
            ...
            _createContainer(t = !1) {
              ...
              if (!t && e.borderStyle.width > 0) {
                ...
                i
                  ? (r.style.borderColor = n.Util.makeHexColor(
                      0 | i[0],
                      0 | i[1],
                      0 | i[2],
                    ))
            ...
            get _commonActions() {
              const setColor = (t, e, s) => {
                const n = s.detail[t];
                s.target.style[e] = a.ColorConverters[`${n[0]}_HTML`](
                  n.slice(1),
                );
              };
            ...
            _getElementsByName(t, e = null) {
              ...
              for (const n of document.getElementsByName(t)) {
                ...
                t !== e &&
                  c.has(n) &&
                  s.push({ id: t, exportValue: i, domElement: n });
              }
              return s;
            }
            static get platform() {
        ...
        (t, e, s) => {
          ...
          function appendText(t, e, s, i) {
            ...
            let b = !1;
            if (e.str.length > 1 || (t._enhanceTextSelection && o.test(e.str)))
              b = !0;
          ...
          function expandBoundsLTR(t, e) {
            ...
            for (const t of e) {
              ...
              for (a = e; a <= r; a++) {
                ...
                let t = !1;
                for (o = e - 1; !t && o >= 0 && s[o].start >= i.y1; o--)
                  t = s[o].boundary === i;
                for (o = r + 1; !t && o < s.length && s[o].end <= i.y2; o++)
                  t = s[o].boundary === i;
            ...
            _processItems(t, e) {
              for (let s = 0, n = t.length; s < n; s++)
                if (void 0 !== t[s].str) {
                  ...
                  null !== t[s].id &&
                    this._container.setAttribute("id", `${t[s].id}`);
              ...
              for (let n = 0, i = this._textDivs.length; n < i; n++) {
                ...
                if (r.hasText)
                  if (t) {
                    ...
                    r.paddingRight > 0
                      ? s.push(r.paddingRight / r.scale + "px")
                      : s.push(0);
                    r.paddingBottom > 0
          ...
          class NetworkManager {
            ...
            onStateChange(t, e) {
              ...
              if (206 === r) {
                ...
                a ? s.onDone({ begin: 0, chunk: a }) : s.onError?.(i.status);
            }
            getRequestXhr(t) {
