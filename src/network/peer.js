...
class PeerNetwork {
    ...
    shareKnownModels(peerId) {
        ...
        const models = Array.from(this.knownModels.entries())
            .slice(0, 3);
    ...
    cleanModelCache() {
        ...
        const entries = Array.from(this.knownModels.entries())
            .sort((a, b) => a[1].timestamp - b[1].timestamp);
        
        const toRemove = entries.slice(0, this.knownModels.size - this.config.modelCacheSize);
