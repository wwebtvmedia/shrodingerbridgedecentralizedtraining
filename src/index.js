...
class SwarmTrainingApp {
    ...
    setupEventListeners() {
        // Connect button
        document.getElementById('connect-btn').addEventListener('click', () => this.connectToSwarm());
    ...
    async startTraining() {
        ...
        try {
            ...
            this.trainer.onEpochComplete = (epoch, loss, metrics) => {
                ...
                // Log progress
                this.ui.log(`Epoch ${epoch}: loss=${loss.toFixed(4)}, diversity=${metrics.diversity.toFixed(3)}`);
            };
